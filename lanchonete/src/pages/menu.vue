...
const categories = ref<Category[]>([
  ...
  },
  {
    ...
    items: [
      ...
      { id: 202, name: 'Aneis de cebola', price: 16.90, image: 'https://images.unsplash.com/photo-1639024471283-03518883512d?w=300' },
  ...
  },
  {
    ...
    name: '🥤 Bebidas',
    items: [
      { id: 301, name: 'Refrigerante', price: 8.90, image: 'https://images.unsplash.com/photo-1629203851122-3726ecdf080e?w=300' },
